...
_Superseded by [ADR 0024](0024-concept-identity-rename-supersession.md): stable ids, rename and supersession are kept; automatic merge and split, and the pinned-set cap, are removed._
