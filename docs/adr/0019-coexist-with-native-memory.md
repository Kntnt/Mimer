...
_Superseded by [ADR 0025](0025-replace-native-auto-memory.md): Mimer replaces native auto memory — a project-scoped disable, detected and warned — rather than coexisting with it._
