...
_Superseded by [ADR 0022](0022-project-identity-remote-or-path.md): identity resolves remote-or-path; the `.mimer` marker file and monorepo-splitting are removed, the confirm-before-binding safeguard kept._
